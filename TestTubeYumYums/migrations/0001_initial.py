...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lower_range', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='vitmin_lower_range', to='TestTubeYumYums.vitmin')),
                ('upper_range', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='vitmin_upper_range', to='TestTubeYumYums.vitmin')),
                ('vitmin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vitmin_report', to='TestTubeYumYums.vitmin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cbc_lower', models.ForeignKey(default=TestTubeYumYums.models.CBC.get_low, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='cbc_lower', to='TestTubeYumYums.cbc')),
                ('cbc_upper', models.ForeignKey(default=TestTubeYumYums.models.CBC.get_high, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='cbc_upper', to='TestTubeYumYums.cbc')),
                ('vitmin_lower', models.ForeignKey(default=TestTubeYumYums.models.VitMin.get_low, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='vitmin_lower', to='TestTubeYumYums.vitmin')),
                ('vitmin_upper', models.ForeignKey(default=TestTubeYumYums.models.VitMin.get_high, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='vitmin_upper', to='TestTubeYumYums.vitmin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cbc', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cbcc_report', to='TestTubeYumYums.cbc')),
                ('lower_range', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cbc_lower_range', to='TestTubeYumYums.cbc')),
                ('upper_range', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cbc_upper_range', to='TestTubeYumYums.cbc')),
